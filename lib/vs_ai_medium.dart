...
class _HomePageState extends State<vs_ai_medium> {
  ...
  void playGame(int index) {
    ...
    if (player1.contains(0) && player1.contains(1) && !player2.contains(2) && solution==0 ){
      ...
      var allPlayedButtons = List.from(player2)..addAll(player1);
      int random = Random().nextInt(8) + 1;
      while (allPlayedButtons.contains(random) && gameisdone == false) {
